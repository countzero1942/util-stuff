...
describe("slice and sliceByLength methods", () => {
	describe("slice", () => {
		it("returns a new StrSlice with the same properties as the original slice", () => {
		...
		it("using positive start and end index", () => {
			const originalSlice = StrSlice.from("hello");
			//                                   012345
			let newSlice: StrSlice;
		...
		it("flips positive start and end index", () => {
			const originalSlice = StrSlice.from("hello");
			//                                   012345
			let newSlice: StrSlice;
		...
		it("using negative start and end index", () => {
			const originalSlice = StrSlice.from("hello");
			//                                   012345
			//                                   54321
			let newSlice: StrSlice;
		...
		it("flips negative start and end index", () => {
			const originalSlice = StrSlice.from("hello");
			//                                   012345
			//                                   54321
			let newSlice: StrSlice;
	...
	describe("sliceByLength", () => {
		it("works with positive start index", () => {
			const originalSlice = StrSlice.from("hello");
			//                                   012345
			let newSlice: StrSlice;
