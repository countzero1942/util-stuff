...
/**
 * Logs ZipSeq of: countSeq, squaresSeq, cubesSeq, trianglesSeq,
 * fibonacciSeq and factorialSeq.
 *
 * The logged ZipSeq is filtered to only include odd numbers.
 *
 * The zipping process is broken up into two stages:
 ...
 * First, countSeq is zipped with: toStrSeq, sevensSeq, elevensSeq and squaresSeq.
 *
 * Then, this object is zipped with: cubesSeq, trianglesSeq, fibonacciSeq
 * and factorialSeq.
 *
 * @param {number} count
 */
...
/**
 * Logs ZipSeq of: countSeq, toStrSeq, sevensSeq, elevensSeq, squaresSeq,
 * cubesSeq, trianglesSeq, fibonacciSeq and factorialSeq.
 *
 * The logged ZipSeq is filtered to only include even numbers.
 *
 * The zipping process is done in one step, instead of chained zips.
 *
 * @param {number} count
 */
